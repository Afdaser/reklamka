<?php
/**
 * Plugin Name: Gallery Slider Block
 * Description: Блок Gutenberg для слайдера галереї з мініатюрами на Bootstrap 4.5.3.
 * Version: 1.0.0
 * Author: Reklamka
 * Text Domain: gsb
 *
...
add_action( 'init', function () {
    // Завантаження перекладів блоку, щоб тексти були локалізовані.
    load_plugin_textdomain( 'gsb', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' );
